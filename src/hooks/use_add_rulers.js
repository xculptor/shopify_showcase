...
const useAddRulers = (
    isAddRuler, setIsAddRuler, experience, scene, allRulers, currProduct, modelList,  changeControl, currControls, xidList, allRulers1
    ...
    if (
      ...
      if (
        ...
        for( let i = 0; i < currRulers.length; i++ ){
          ...
          createRuler(scene, object_xid, isRuler, currRulers[i]);
